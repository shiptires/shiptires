...
export const metadata: Metadata = {
  title: "F1 Tire Strategy & Technology | Ship.Tires",
  description:
    "Pirelli compound breakdowns, pit stop strategy analysis, and Formula 1 tire technology deep dives. From soft to hard, understand the rubber that decides every Grand Prix.",
};

export default function F1Page() {
  const articles = racingArticles.filter((a) => a.series === "f1");
    ...
    <div className="bg-gray-50">
      ...
      <div className="relative bg-navy text-white overflow-hidden">
        <Image
          ...
          alt="Formula 1 racing tire technology"
          fill
          priority
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          ...
          <p className="mt-3 text-lg text-gray-400 max-w-2xl">
            Pirelli compound analysis, undercut and overcut breakdowns, and the
            tire decisions that shape every Grand Prix weekend.
          </p>
        </div>
      </div>
