...
const faqs = [
  {
    ...
    items: [
      { q: "How do I order tires?", a: "Browse our catalog, find the tires you want, and click 'Request Quote' to get pricing. You can also call us at (916) 476-7689 for immediate assistance. We'll provide a quote and process your order quickly." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Can I change my tire size?", a: "In some cases, yes — but it depends on your vehicle. Different sizes can affect speedometer accuracy, handling, and clearance. Call us and our experts can advise on safe alternatives." },
          ...
          <div className="rounded-xl bg-navy p-8 text-center text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                <a href="tel:+19164767689" className="rounded-lg bg-orange px-6 py-3 text-sm font-bold text-white hover:bg-orange-light transition-colors">
                  Call (916) 476-7689
                </a>
